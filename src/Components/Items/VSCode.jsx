...
function ItemVSCode() {
  return (
    <Link to='/download-vs-code' className='no-decor col-xl-2 col-lg-2 col-md-2 col-sm-4 col-xs-12 mb-5 mt-auto pr-auto pl-auto mr-auto ml-auto box-alt'>
      <div className='row'>
        ...
        <div className='col-12 bg-primary text-white pt-1 pb-1'>
            <div className='row text-white'>
              ...
              <div className='col-6 text-right'>
                <span className='small'>v1.33</span>
              </div>
            </div>
        </div>
      </div>
