...
function VSCode() {
  ...
  function downloadWindows64App () {
    window.open('https://cdn.appzaib.com/media/wixware/apps/vscode/1.33-337395977725792685628694759262825493683878/wixware.com-vscode-1.33-x64.exe');
  }
  function downloadWindows32App () {
    window.open('https://cdn.appzaib.com/media/wixware/apps/vscode/1.33-554693773929834244436969755897883922683397/wixware.com-vscode-1.33-x86.exe');
  }
  ...
  return (
    <div>
      <Helmet>
        <title>Download VS Code - Wixware</title>
      ...
      <div className='container-fluid mt-5 pl-5 pr-5'>
        <div className='row'>
          <div className='col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12 box pl-5 pr-5 pt-5 pb-5'>
            <h1>Download VS Code</h1>
            <h5 className='text-muted'>By <a href='https://www.microsoft.com/?ref_by=wixware.com' target='_ublank' className='text-primary'>Microsoft</a> <i className='fa fa-check-circle text-primary'></i></h5>
            <div className='row'>
             <div className='col-4'>
                <span className='text-muted'><span className='badge badge-success'>Free &amp; Open Source</span></span>
              </div>
              <div className='col-4 text-center'>
                <span className='text-muted'><span className='badge badge-primary'>v1.33</span></span>
              </div>
            ...
            <p>Visual Studio Code is a source-code editor developed by Microsoft for Windows, Linux and macOS. It includes support for debugging, embedded Git control and GitHub, syntax highlighting, intelligent code completion, snippets, and code refactoring.</p>
            <p className=''>Go beyond syntax highlighting and autocomplete with IntelliSense, which provides smart completions based on variable types, function definitions, and imported modules.</p>
          ...
          <div className='col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 text-center ml-auto'>
            <div className='row'>
              <div className='col-12 box'>
                <img src='https://cdn.appzaib.com/public/wixware/img/vscode.png' className='mt-5 img-fluid' alt='Download VS Code' />
                <br/>
                <br/>
                <span className='text-muted'><i className='fa fa-download'></i> 11 Downloads</span>
                <br/>
                <br/>
              ...
              <div className='col-12 box mt-5 pb-5'>
                ...
                <h6 className='mb-5 text-muted'>Wixware Performance Test</h6>
                  <div className='row mt-4'>
                    ...
                    <div className='col-4 text-right'>
                      <span className='small'>WPS 9.8/10</span>
                    </div>
                  </div>
                  <div className="progress pointer mt-3" style={progressBarStyles}>
                    <div className="progress-bar" role="progressbar" style={progressBarOne} aria-valuenow="98" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
                <div className='col-12 pointer' data-toggle='tooltip' title="Wixware Performance Score">
                  <div className='row mt-4'>
                    ...
                    <div className='col-4 text-right'>
                      <span className='small'>WPS 9.9/10</span>
                    </div>
                  </div>
                  <div className="progress pointer mt-3" style={progressBarStyles}>
                    <div className="progress-bar" role="progressbar" style={progressBarTwo} aria-valuenow="99" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
            </div>
